...
public class Money {
	...
	//MUST COMPLETE THIS
	public boolean equals(Object obj) //check if two objects are equal and returns the result
	{
		if(obj == null) //check if object is null
			return false;
		else if(this.getClass() != obj.getClass()) //check if objects are of same class
			return false;
		else //returns true if they contain the same values for their instance variables
		{
			Money d = (Money) obj;
			return (this.dollars == d.dollars && this.cents == d.cents); 
		}
	}
